...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Cashflow web application."
  #
  #
  ...
  #
  # settings.secret_key_base= HtK5JF_nGg2bFo3URoLYxDEfjZ57Jl0lK6SF6gmdXBE
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("cashflow.log", "w"))
  #
  #
end
